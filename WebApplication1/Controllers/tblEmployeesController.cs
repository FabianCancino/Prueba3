...
namespace WebApplication1.Controllers
{
    public class tblEmployeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IDEmployee,Name")] tblEmployee tblEmployee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IDEmployee,Name")] tblEmployee tblEmployee)
        {
            if (ModelState.IsValid)
            {
